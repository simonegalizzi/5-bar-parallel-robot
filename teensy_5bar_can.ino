...
void PID_B(){
  ...
  motorB.PID_velocity.I = 1.0;
  motorB.PID_velocity.D = 0.0;
  motorB.PID_velocity.output_ramp = 1000.0;
  motorB.PID_velocity.limit = 10;
  // Low pass filtering time constant 
  motorB.LPF_velocity.Tf = 0.001;
  // angle loop PID
  motorB.P_angle.P = 8.0;
  motorB.P_angle.I = 0.0;
  motorB.P_angle.D = 0.0;
  motorB.P_angle.output_ramp = 0.0;
  motorB.P_angle.limit = 10.0;
  // Low pass filtering time constant 
...
void ricevi() {
  ...
  if ( can1.read(msg) ) {
   ...
   // Serial.print(String(comandoA));Serial.print(" "); Serial.print(String(comandoB));
   // Serial.println();
